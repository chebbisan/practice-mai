...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.spin_N = QSpinBox(); self.spin_N.setRange(1, 256); self.spin_N.setValue(16)
        self.spin_Nx = QSpinBox(); self.spin_Nx.setRange(1, 256); self.spin_Nx.setValue(16)
        self.spin_Ny = QSpinBox(); self.spin_Ny.setRange(1, 256); self.spin_Ny.setValue(16)

        self.spin_freq = QDoubleSpinBox()
        self.spin_freq.setRange(0.1, 100.0); self.spin_freq.setValue(3.0)
        self.spin_freq.setSuffix(" ГГц"); self.spin_freq.setDecimals(2)

        self.spin_steer_x = QDoubleSpinBox()
        self.spin_steer_x.setRange(-89.0, 89.0); self.spin_steer_x.setValue(30.0)
        self.spin_steer_x.setSuffix("°"); self.spin_steer_x.setDecimals(1)

        self.spin_steer_y = QDoubleSpinBox()
        self.spin_steer_y.setRange(-89.0, 89.0); self.spin_steer_y.setValue(30.0)
        self.spin_steer_y.setSuffix("°"); self.spin_steer_y.setDecimals(1)

        self.spin_points = QSpinBox(); self.spin_points.setRange(51, 1001)
        self.spin_points.setValue(181); self.spin_points.setSingleStep(10)
